    ...
    <div className="bg-black min-h-screen text-white overflow-hidden">
      ...
      <section className="py-32 px-6 bg-black relative z-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Specijalizovani smo za profesionalno fotografisanje, snimanje, 360°
            ture i dron snimke nekretnina. Naš cilj je da prenesemo atmosferu i
            luksuz svakog prostora, privlačeći prave kupce.
          </motion.p>
        </div>
      </section>
        ...
        <div className="relative z-20 px-6 max-w-7xl mx-auto w-full">
          ...
          >
            ...
            <p className="text-white/70 text-lg leading-relaxed">
              Od dnevne sobe do kuhinje — svaki prostor prikazan tačno onako
              kako kupci žele da ga vide.
            </p>
          </motion.div>
        </div>
      </section>
